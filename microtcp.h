...
typedef struct microtcp_buffered_packet {
    size_t seq_number;    //packet's seq number
    size_t data_len;      //packet's data length
    char *data;           //packet's data
    struct microtcp_buffered_packet *next; //pointer to next packet
} microtcp_buffered_packet_t;
...
typedef struct
{
  ...
  microtcp_mode_t mode;         /**< The mode of the microTCP socket */
...
//Added: Linked list for out-of-order packets
  microtcp_buffered_packet_t *out_of_order_head;
